    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-bold text-gray-900">Create Bus</h2>
                <p class="mt-2 text-gray-600">Add new bus information to the system</p>
            </div>
            ...
            <form action="{{ route('admin.businfo.store') }}" method="POST" class="space-y-6">
                @csrf
                <div>
                    <label for="busName" class="block text-sm font-medium text-gray-700 mb-2">
                        Bus Name <span class="text-red-500">*</span>
                    </label>
                    <input type="text" name="busName" id="busName" required
                        ...
                        placeholder="e.g., UniRide Express 1">
                    @error('busName')
                ...
                <div>
                    ...
                    <input type="text" name="engineNumber" id="engineNumber" required
                ...
                <div>
                    <label for="passengerCapacity" class="block text-sm font-medium text-gray-700 mb-2">
                        Passenger Capacity <span class="text-red-500">*</span>
                    </label>
                    <input type="number" name="passengerCapacity" id="passengerCapacity" required min="1"
                        value="{{ old('passengerCapacity') }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-200"
                        placeholder="e.g., 50">
